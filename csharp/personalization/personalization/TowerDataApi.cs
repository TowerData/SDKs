...
namespace Personalization
{
    ...
    public class TowerDataApi
    {
        ...
        private const String BASE_URL_DIRECT = "https://api.towerdata.com/v5/td";
        private const String BASE_URL_BULK = "https://api.towerdata.com/v5/ei/bulk";
        ...
        public TowerDataApi(String apiKey) : this(apiKey, DEFAULT_DIRECT_TIMEOUT, DEFAULT_BULK_TIMEOUT) { }
        ...
        /// show_available is set to false
        public TowerDataApi(String apiKey, int direct_timeout, int bulk_timeout) : this(apiKey, direct_timeout, bulk_timeout, false) { }
        ...
        /// </param>
        public TowerDataApi(String apiKey, int direct_timeout, int bulk_timeout, bool show_available)
        {
